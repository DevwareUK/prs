...
- `prs tool issue estimate <issue-number> --json` returns the same estimate as structured JSON for active Codex sessions and automation, including per-profile cost ranges and cost-basis metadata
