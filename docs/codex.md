...
The five available names are `$prs`, `$prs-create`, `$prs-issue`, `$prs-finish`, and `$prs-orchestrate`. This is Codex syntax only; other hosts document their own invocation behavior.
