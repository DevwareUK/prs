...
export const PRS_CODEX_SKILLS: ManagedCodexSkill[] = [
  {
    ...
    body: [
      ...
      "- `/prs issue <number> estimate`: run `prs tool issue estimate <number> --json`, show the returned token ranges, rough USD cost ranges, cost-basis metadata, confidence, drivers, warnings, and recommendation, and stop. This route is read-only: do not launch a runtime, edit files, commit, push, or publish GitHub comments.",
