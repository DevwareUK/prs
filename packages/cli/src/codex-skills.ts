...
export const PRS_CODEX_SKILLS: ManagedCodexSkill[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "If the user approves, create the issue through the configured forge flow and publish any approved Superpowers spec and plan artifacts to managed GitHub issue comments containing `<!-- prs:issue-spec -->` and `<!-- prs:issue-plan -->`; if the flow cannot publish them automatically, clearly instruct the user or next agent to publish those marker-based comments before estimating.",
