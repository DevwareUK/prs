...
export const PRS_CODEX_SKILLS: ManagedCodexSkill[] = [
  ...
  },
  {
    ...
    body: [
      ...
      `For \`/prs:pr <number> review\`, run \`${renderPrReviewToolCommand()}\`; read the returned \`promptFilePath\` and \`contextFilePath\`, inspect the prepared checkout in this active Codex session, and write the final report to the returned \`reportFilePath\`. Do not edit code, commit, push, resolve comments, or post to GitHub.`,
